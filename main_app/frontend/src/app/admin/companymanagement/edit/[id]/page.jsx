    ...
    const loadCompanyData = async () => {
      ...
      try {
        ...
        setCompanyData({
          ...
          total_active_jobs: company.total_active_jobs || 0,
          total_applicants: company.total_applicants || 0,
          total_hired: company.total_hired || 0,
          awaited_approval: company.awaited_approval || 0,
        });
        ...
        alert('Failed to load company data. Redirecting back...');
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        // Only include the logo if a new one is selected
        if (companyImage) {
          formattedData.logo = companyImage;
        }
        
        console.log('Submitting updated company data:', formattedData);
        
        // Submit to API
        const response = await updateCompany(companyId, formattedData);
        ...
        if (error.response?.data) {
          ...
          setFormErrors(prev => ({
            ...prev,
            api_error: 'Failed to update company. Please try again.'
          }));
        }
      } finally {
      ...
      <div className="h-full flex items-center justify-center bg-gray-50">
        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 max-w-md w-full">
          <div className="flex flex-col items-center justify-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Company Updated!</h2>
            <p className="text-gray-600 text-center mb-6">
              The company profile has been successfully updated.
            </p>
    ...
    <div className="h-full overflow-y-auto bg-gray-50">
      <div className="container mx-auto py-8 px-4 md:px-6">
        ...
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Edit Company: {companyData.name}</h1>
        </div>
