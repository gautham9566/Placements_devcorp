 ...
 */
export default function CommentsSection({ contentType, contentId, lmsUsername, isAdmin = false }) {
  ...
  const fetchComments = async () => {
    try {
      ...
      const response = await fetch(
        `/api/engagement/comments?content_type=${contentType}&content_id=${contentId}`
      );
    ...
    <div className="w-full">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div className="px-6 pt-6 pb-4">
          <div
            className="flex items-center justify-between cursor-pointer hover:bg-white dark:hover:bg-gray-800 hover:shadow-sm dark:hover:shadow-md rounded-lg px-4 py-3 transition-all duration-200 border border-transparent hover:border-blue-200 dark:hover:border-gray-700"
            onClick={() => comments.length > 0 && setCommentsExpanded(!commentsExpanded)}
          >
            <div>
